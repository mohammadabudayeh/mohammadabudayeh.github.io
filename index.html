...
<head>
    ...
    <meta name="description" content="Mohammad AbuDayeh, Software engineer, security examiner in the field of information technology, and expert in examining servers and websites">
    <meta name="keywords" content="Cyber Security, Ethical Hacker,Programmer PHP, software engineer, Security checker,Mohammad AbuDayeh, AbuDayeh">
    <title>Mohammad AbuDayeh CV/Resume</title>
...
<body>
        ...
        <div id="loading-center">
            <div id="loading-center-absolute">
                ...
                <div class="text-holder text-center">
                    <h2>Mohammad AbuDayeh</h2>
                    <h6>Software Engineer & Cyber Security</h6>
                </div>
            </div>
        </div>
    </div>
    <header id="home">
        <nav id="theMenu" class="menu">
            <div id="menu-options" class="menu-wrap">
                <div class="logo-flat">
                    <img alt="personal-logo" class="img-responsive" src="images/Dayeh.png">
                </div>
                <br>
                <a href="#home"><i class="title-icon fa fa-user"></i>Home</a>
                <a href="#about"><i class="fas fa-tachometer-alt"></i>About</a>
                <a href="#education"><i class="title-icon fa fa-graduation-cap"></i>Education</a>
                <a href="#skills"><i class="title-icon fas fa-sliders-h"></i>Skills</a>
                            ...
                            <div id="v-card" class="card">
                                ...
                                <div class="card-content">
                                    <div class="info-headings">
                                        <h4 class="text-capitalize left">Mohammad AbuDayeh</h4>
                                        <h6 class="text-capitalize left">Software Engineer & Ethical Hacker</h6>
                                    </div>
                                    <div class="infos">
                                        <ul class="profile-list">
                                            <li class="clearfix">
                                                <span class="title"><i class="fas fa-envelope"></i></span>
                                                <span class="content">e@hotmail.com</span>
                                            </li>
                                            <li class="clearfix">
                                                <span class="title"><i class="fas fa-globe-europe"></i></span>
                                                <span class="content">abudayeh.me</span>
                                            </li>
                                            <li class="clearfix">
                                                <span class="title"><i class="fas fa-phone-volume"></i></span>
                                                <span class="content">+962785685087</span>
                                            </li>
                                            <li class="clearfix">
                                                <span class="title"><i class="fas fa-map-marker-alt"></i></span>
                                                <span class="content">Jordan,Amman</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="links">
                                        <a href="https://facebook.com/xdayeh" id="first_one"
                                           class="social btn-floating indigo" target="_blank">
                                            <i class="fab fa-facebook-f"></i></a>
                                        <a href="https://twitter.com/xdayeh" class="social  btn-floating blue" target="_blank">
                                            <i class="fab fa-twitter"></i></a>
                                        <a href="https://jo.linkedin.com/in/abudayeh" class="social  btn-floating blue darken-3" target="_blank">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="about-card" class="card">
                        <div class="card-content">
                            <p>
                                I’m an Ethical Hacker with over 9 years of experience in
                                checking servers, analyzing hacking operations, 
                                protecting servers and devices from any cyber attack, 
                                discovering and reporting network vulnerabilities and
                                obtaining cyber security certificates.
                            </p>
                        </div>
                        <div id="about-btn" class="card-action">
                            <div class="about-btn">
                                <a href="https://abudayeh.me/Mohammad-AbuDayeh.pdf" target="_blank" class="btn waves-effect"><i class="fas fa-file-download"></i> Download CV</a>
                                <a href="#contact" class="btn waves-effect"><i class="fas fa-envelope"></i> Contact Me</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div id="timeline-education">
                    ...
                    <div class="card timeline-content">
                        <div class="card-content">
                            ...
                            <div class="timeline-info">
                                <h6>
                                    <small>Osaid School</small>
                                </h6>
                                <h6>
                                    <small>Jan 2000 - Mar 2009</small>
                                </h6>
                            </div>
                            <p>
                ...
                <div class="timeline-block">
                    ...
                    <div class="card timeline-content">
                        <div class="card-content">
                            ...
                            <div class="timeline-info">
                                <h6>
                                    <small>Abu Bakr al-Razi College</small>
                                </h6>
                                <h6>
                                    <small>Jan 2009 - Mar 2012</small>
                                </h6>
                            </div>
                            <p>
                ...
                <div class="timeline-block">
                    ...
                    <div class="card timeline-content">
                        <div class="card-content">
                            ...
                            <div class="timeline-info">
                                <h6>
                                    <small>University of Islamic Sciences</small>
                                </h6>
                                <h6>
                                    <small>Jan 2014 - Mar 2017</small>
                                </h6>
                            </div>
                            <p>
                                I completed my Software Engineering degree from this prestigious institution.
                                I successful completed all the credits without any fallout and got A grade overall.
                            </p>
                ...
                <div class="timeline-block">
                    ...
                    <div class="card timeline-content">
                        <div class="card-content">
                            <h6 class="timeline-title">Ethical Hacker</h6>
                            <div class="timeline-info">
                                <h6>
                                    <small>EC-Council</small>
                                </h6>
                                <h6>
                                    <small>Jan 2018 - Mar 2019</small>
                                </h6>
                            </div>
                            <p>
                ...
                <div class="timeline-block">
                    ...
                    <div class="card timeline-content">
                        <div class="card-content">
                            <h6 class="timeline-title">Cyber Security</h6>
                            <div class="timeline-info">
                                <h6>
                                    <small>Hussein Technical University (HTU)</small>
                                </h6>
                                <h6>
                                    <small>Feb 2020 - May 2020</small>
                                </h6>
                            </div>
                            <p>
                                <span style="color: #06A763;">On study benches</span>
                            </p>
    ...
    <section id="skills" class="section">
        <div class="container">
            <div class="section-title">
                <h4 class="text-uppercase text-center"><i class="title-icon fas fa-sliders-h"></i>Skills</h4>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="skillbar" data-percent="95%">
                                        <div class="skillbar-title"><span>Respond to cyber attacks</span></div>
                                        <div class="skillbar-bar"></div>
                                        <div class="skill-bar-percent">95%</div>
                                    </div>
                                    <div class="skillbar" data-percent="90%">
                                        <div class="skillbar-title"><span>Penetration analysis</span></div>
                                        <div class="skillbar-bar"></div>
                                        <div class="skill-bar-percent">90%</div>
                                    </div>
                                    <div class="skillbar" data-percent="90%">
                                        <div class="skillbar-title"><span>Check vulnerabilities</span></div>
                                        <div class="skillbar-bar"></div>
                                        <div class="skill-bar-percent">90%</div>
                                    </div>
                                    <div class="skillbar" data-percent="90%">
                                        <div class="skillbar-title"><span>Protecting the network </span></div>
                                        <div class="skillbar-bar"></div>
                                        <div class="skill-bar-percent">90%</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="skills-title">
                                        <h6 class="text-center">Operating Systems</h6>
                                    </div>
                                    <div class="skillbar" data-percent="90%">
                                    ...
                                    <div class="skillbar" data-percent="80%">
                                        <div class="skillbar-title"><span>macOS</span></div>
                                        <div class="skillbar-bar"></div>
                                        <div class="skill-bar-percent">80%</div>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header  text-center">
                    ...
                    <h4 class="modal-title" id="myModalLabel-1">Preparatory Education</h4>
                    <h6>
                        <small>Jan 2000 - Mar 2009</small>
                    </h6>
                </div>
    ...
    <div id="myModal-2" class="modal fade">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header  text-center">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel-2">Cyber Security</h4>
                    <h6>
                        <small>Feb 2020 - Mar 2020</small>
                    </h6>
                </div>
                <div class="modal-body">
                    <p>
                       Currently, I am working hard to obtain a degree
                    </p>
                </div>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
    ...
    <footer>
        <div class="container">
            <p class="text-center">
                © Mohammad CV. All right reserved by
                <a href="http://abudayeh.me/" target="_blank">
                    <strong>AbuDayeh</strong>
                </a>
            </p>
        </div>
    </footer>
